...
class MyLineEdit(QLineEdit):
    ...
    def keyPressEvent(self, event):
        ...
        if (modifiers and modifiers & MOD_MASK == modifiers and key > 0 and key != Qt.Key_Shift and key != Qt.Key_Alt and key != Qt.Key_Control and key != Qt.Key_Meta):
