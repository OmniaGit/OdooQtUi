...
LABEL_STYLE = 'font-weight: bold;margin-right: 0px;font-size: 11px;line-height: 1.42857143;'
...
NOOTEBOOK_TABBAR_STYLE = 'QTabBar::tab:!selected {border: 4px solid grey;border-left-style: none;border-right-style: none;border-top-style: none;min-width:150px;} QTabBar::tab:selected, QTabBar::tab:hover {border: 4px solid #893b74;border-left-style: none;border-right-style: none;border-top-style: none;color: #893b74;font-size: 12px;font-weight: bold;min-width:150px}'