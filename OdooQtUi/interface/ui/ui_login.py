...
class Ui_dialog_login(object):
    def setupUi(self, dialog_login):
        ...
        self.label_company = QtWidgets.QLabel(self.page_2)
        self.label_company.setObjectName(_fromUtf8("label_company"))
        self.gridLayout_3.addWidget(self.label_company, 4, 0, 1, 1)
        self.comboBox_company = QtWidgets.QComboBox(self.page_2)
        self.comboBox_company.setMaxVisibleItems(10)
        self.comboBox_company.setObjectName(_fromUtf8("comboBox_company"))
        self.gridLayout_3.addWidget(self.comboBox_company, 4, 1, 1, 1)
        ...
        dialog_login.setTabOrder(self.lineEdit_password, self.comboBox_company)
        dialog_login.setTabOrder(self.comboBox_company, self.pushButton_ok)
    ...
    def retranslateUi(self, dialog_login):
        ...
        self.label_company.setText(_translate("dialog_login", "Company", None))
