...
"use strict";
console.error("omnia Custom js loading")
...
var hide_navbar = function(){
    var navbar = document.getElementsByClassName('o_navbar');
    if(navbar){
        console.error("HIDED NVB")
        navbar[0].style = "display:None";
        var breadcrumb = document.getElementsByClassName('o_control_panel');
...
var hide_form_items = function(){
    setTimeout(function(){
        hide_navbar();
        var control_panel = document.getElementsByClassName('o_control_panel');
        if(control_panel){
            console.error("HIDED CP")
            control_panel[0].style="display:None";
        }
    },1000) 
} 
