...
BUTTON_STYLE = 'border-radius: 0px;border: none;color: white;background-color: #21b799;border-color: #21b799;padding: 5px 10px;font-size: 12px;font-weight:bold;'
...
BUTTON_STYLE_MANY_2_ONE = 'border-radius: 0px;border: none;color: white;background-color: #3eb2df;border-color: #21b799;padding: 5px 10px;font-size: 12px;max-width:30px;max-height:10px;font-weight:bold;'
BUTTON_ADD_AN_ITEM = 'border: none;color:blue;font-weight: bold;background-color:white;'
LABEL_STYLE = 'margin-right: 0px;font-size: 12px;line-height: 1.42857143;font-weight: bold;'
